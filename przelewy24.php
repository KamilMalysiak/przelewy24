...
class Przelewy24 extends PaymentModule
{
    ...
    public function hookDisplayAdminOrderMain($params)
    {
        ...
        $returnValue = (true === $this->context->smarty->getTemplateVars('getRefundInfo'))
            ? $this->display(__FILE__, 'transaction_refund_177.tpl')
            : '' ;
    ...
    public function hookDisplayAdminOrderLeft($params)
    {
        ...
        /* explicit boolean value is intentional */
        $returnValue = (true === $this->context->smarty->getTemplateVars('getRefundInfo'))
            ? $this->display(__FILE__, 'transactionRefund.tpl')
            : '' ;
    ...
    private function prepDataForRefunds(Order $order)
    {
        ...
        /* getRefundInfo showing of refund form had to be tied to this variable. */
